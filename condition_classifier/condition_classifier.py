...
#it has a good or bad condition, then returns a feature vector representing that
def classifyCondition(): 
    
    #Load keras model
    model = load_model('/cs/home/dag8/Documents/Dissertation/Code/API/condition_classifier/ResNet50.h5') 
    ...
    condition = np.argmax(pred, axis=1)
